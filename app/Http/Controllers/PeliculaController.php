...
class PeliculaController extends Controller
{
    ...
    {
        $peliculas['peliculas'] = Pelicula::paginate(5);

        return view('pelicula.index', $peliculas);
        /*
$peliculas = Pelicula::paginate();
    ...
    public function update(Request $request, Pelicula $pelicula)
    {
        ...
        return redirect()->route('peliculas.index')
            ->with('success', 'Pelicula Actualizada con Exito!');
        /*
        request()->validate(Pelicula::$rules);
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('peliculas.index')
            ->with('success', 'Pelicula Eliminada con Exito!');
    }
}
